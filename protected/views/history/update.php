...
echo Chosen::multiSelect('medicind', $model->medicind != '' ? explode(',', $model->medicind) : '' , $internal_medicine,
    array(
...
echo Chosen::multiSelect('external_medicine', $model->external_medicine != '' ? explode(',', $model->external_medicine) : '' , $external_medicine,
    array(
...
echo Chosen::multiSelect('referral', $model->referral != '' ? explode(',', $model->referral): '', $referral_array,
    array(
